 ...
 * - certificate/cert: (string or buffer) TLS certificate (required for TLS with key)
 * - key: (string or buffer) TLS private key (required for TLS with certificate)
 * - ciphers: (string) TLS cipher suite specification (see tls.createSecureContext)
 ...
 *
 * For more TLS options, see Node.js tls.createSecureContext documentation.
 *
